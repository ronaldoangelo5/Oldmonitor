		...
		<script>
			...
			$(function () {
				var chart = c3.generate({
					...
					data: {
						columns: [
							['OnProgress', <?php echo $dp22.", ".$dp3.", ".$dp4.", ".$dp5.", ".$dp6.", ".$dp7.", ".$dp8.", ".$dp9.", ".$dp10.", ".$dp12.", ".$dp13.", ".$dp14.", ".$dp15.", ".$dp16 ?>],
							['Closed', <?php echo $dc22.", ".$dc3.", ".$dc4.", ".$dc5.", ".$dc6.", ".$dc7.", ".$dc8.", ".$dc9.", ".$dc10.", ".$dc12.", ".$dc13.", ".$dc14.", ".$dc15.", ".$dc16 ?>],
					...
					axis: {
						x: {
							...
							categories: [
											'<?php echo $hp22['nameptl'] ?>',
											'<?php echo $hp3['nameptl'] ?>',
											'<?php echo $hp4['nameptl'] ?>',
											'<?php echo $hp5['nameptl'] ?>',
											'<?php echo $hp6['nameptl'] ?>',
											'<?php echo $hp7['nameptl'] ?>',
											'<?php echo $hp8['nameptl'] ?>',
											'<?php echo $hp9['nameptl'] ?>',
											'<?php echo $hp10['nameptl'] ?>',
											'<?php echo $hp12['nameptl'] ?>',
											'<?php echo $hp13['nameptl'] ?>',
											'<?php echo $hp14['nameptl'] ?>',
											'<?php echo $hp15['nameptl'] ?>',
											'<?php echo $hp16['nameptl'] ?>',
							]
						}
					},
					color: {
			...
			*/
			...
			$(function () {
				var chart = c3.generate({
					...
					color: {
						pattern:['#ED5565', '#4FC1E9', '#4FC1E9', '#ED5565']
					}
				});
			});
					...
					data: {
						columns: [
							...
							['Persentase', 
								...
								for($i=0;$i<$nu;$i++){ ?>
									<?php echo json_encode($dc[$i] / (($dc[$i]) + $dp[$i]) * 100) ?>,
								<?php
								}  
			...
			$(function () {
				var chart = c3.generate({
					...
					grid: {
						...
						y: {
							lines: [{value: 0.3}, {value: 0.8, class: 'grid800', text: 'LABEL 800'}]
						}
					},
					*/
