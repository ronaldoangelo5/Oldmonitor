								...
								while($data = mysqli_fetch_array($query)){ ?>
									<tr>
										<?php
											...
											if($data['p_status'] == 51 or $data['p_status'] == 44){
												...
												if($data['p_bai_date'] == null or $data['p_bai_date'] == ""){
													...
													$create 	= date('Y-m-d', strtotime($data['c_created_date']));
													$dispo		= date('Y-m-d', strtotime($data['c_dispo_date']));

													$CheckInX 	= explode("-", $create);
										...
										?>
										<td><a href="?modul=detail&id=<?php echo $data['p_id'] ?>"><span class="label <?php echo $label ?> label-mini"><?php echo $interval ?> </span></a></td>
