										...
										<div class="prf-contacts">
											...
											<div class="location-info">
												...
												<div class="row">
													...
													<div class="col-md-9"><h5>: <?php echo date('H:i d M, Y', strtotime($data['c_created_date']));?></h5></div>
												</div>
												
												<div class="row">
													<div class="col-md-3"><h5 class="bold">Disposition On</h5></div>
													<div class="col-md-9"><h5>: <?php echo date('H:i d M, Y', strtotime($data['c_dispo_date']));?></h5></div>
												</div>

												<div class="row">
													<div class="col-md-3"><h5 class="bold">BAI Date</h5></div>
													<div class="col-md-9"><h5>: <?php if($data['p_bai_date'] != null){ echo date('d M, Y', strtotime($data['p_bai_date'])); }?></h5></div>
												</div>
												<br/><br/>
