                ...
                <div class="panel-body">
                    ...
                    <ul class="to-do-list">
                        ...
                        for($i=0; $i<$d99; $i++){
                            ...
                            if($rank[$i] >= 0.67 && $rank[$i] <= 1){
                                $aaa++;                                
                            }
                            elseif($rank[$i] >= 0.34 && $rank[$i] <= 0.66){
                                $bbb++;
                            }
                            else{
                                $ccc++;
                            ...
                            <li class="clearfix">
                                <p class="todo-title">
                                    Sangat Produktif: <?php echo $aaa;?> -  (<?php echo sprintf("%0.2f", (($aaa/$d99) * 100))?>%) 
                                </p>
                            </li>
                            <li class="clearfix">
                                <p data-toggle="dropdown" class="todo-title">
                                    Cukup Produktif: <?php echo $bbb; ?> - (<?php echo sprintf("%0.2f", (($bbb/$d99) * 100))?>%) 
                                </p>
                            </li>
                            <li class="clearfix">
                            <div class="btn-group">
                                <p class="todo-title">
                                    Kurang Produktif: <?php echo $ccc; ?> - (<?php echo sprintf("%0.2f", (($ccc/$d99) * 100))?>%) 
                                </p>
                            </li>                            
                ...
                <div class="panel-body">
                    <ul class="to-do-list" id="sortable-todo"> 
                        ...
                        $gr1 = "SELECT *, COUNT(*) as total FROM m_project b
                                LEFT JOIN m_crm2 a ON b.p_c_id=a.c_id
                                WHERE
                                b.p_nilai_gr > 0 AND b.p_nilai_gr <= 10000000";

                        $gr2 = "SELECT *, COUNT(*) as total FROM m_project b
                                LEFT JOIN m_crm2 a ON b.p_c_id=a.c_id
                                WHERE
                                b.p_nilai_gr > 10000000 AND b.p_nilai_gr <= 50000000";
                        ...
                        <li class="clearfix">
                            <p class="todo-title">
                                0 - 10 Juta  : <?php echo $fgr1['total'] ?> - (<?php echo sprintf("%0.2f", ($fgr1['total'] / $avgfgr) * 100) ?>%)
                            </p>
                        </li>
                        <li class="clearfix">
                            <p class="todo-title">
                                10 - 50 Juta : <?php echo $fgr2['total'] ?> - (<?php echo sprintf("%0.2f", ($fgr2['total'] / $avgfgr) * 100) ?>%)
                            </p>
                        </li>
                        <li class="clearfix">
                            <p class="todo-title">
